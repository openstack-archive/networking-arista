...
class AristaResourcesBaseTest(base.BaseTestCase):
    ...
    def test_clear_cvx_data(self):
        ...
        ar.cvx_ids = set([i for i in xrange(10)])
    ...
    def test_clear_neutron_data(self):
        # Setup
        ar = resources.AristaResourcesBase(self.rpc)
        ar.neutron_resources = {i: {'id': i} for i in xrange(10)}
    ...
    def test_delete_neutron_resource(self):
        # Setup
        neutron_resources = {i: {'id': i} for i in xrange(10)}
        ar = resources.AristaResourcesBase(self.rpc)
    ...
    def test_resources_ids_to_delete(self):
        # Setup
        neutron_ids = set(xrange(7))
        cvx_ids = set(xrange(3, 10))
        ar = resources.AristaResourcesBase(self.rpc)
    ...
    def test_resource_ids_to_create(self):
        # Setup
        cvx_resource_ids = set(xrange(0, 20, 2))
        neutron_resource_ids = set(xrange(10))
        ar = resources.AristaResourcesBase(self.rpc)
        ...
        # neutron, but not cvx
        self.assertEqual(ar.resource_ids_to_create(), set(xrange(1, 10, 2)))
    ...
    def test_format_for_create(self):
        ...
        test_cases = [(neutron_data[i], expected_cvx_data[i])
                      for i in xrange(len(neutron_data))]
