...
class RealNetStorageAristaDriverTestCase(testlib_api.SqlTestCase):
    ...
    def test_cleanup_on_start(self):
        ...
        db_lib.remember_network('t1', 'n1', 10, 'segment_id_10')
        db_lib.remember_network('t2', 'n2', 20, 'segment_id_20')
        db_lib.remember_network('admin', 'ha-network', 100, 'segment_id_100')
        db_lib.remember_network('t3', 'n3', 30, 'segment_id_30')
...
class SyncServiceTest(testlib_api.SqlTestCase):
    ...
    def test_synchronize_required(self):
        ...
        self.rpc.is_cvx_available.return_value = True
        ...
        expected_calls = [
            ...
            mock.call.is_cvx_available(),
            mock.call.sync_start(),
            mock.call.check_cvx_availability_and_functionality(),
    ...
    def test_synchronize_all_networks(self):
        ...
        # methods.
        self.assertTrue(self.rpc.mock_calls[8] in expected_calls[8:10],
                        "Seen: %s\nExpected: %s" % (
                            self.rpc.mock_calls,
                            expected_calls,
                            )
        ...
        # methods.
        self.assertTrue(self.rpc.mock_calls[9] in expected_calls[8:10],
                        "Seen: %s\nExpected: %s" % (
                            self.rpc.mock_calls,
                            expected_calls,
                            )
        ...
        self.assertTrue(self.rpc.mock_calls[10:] == expected_calls[10:],
                        "Seen: %s\nExpected: %s" % (
                            self.rpc.mock_calls,
                            expected_calls,
                            )
