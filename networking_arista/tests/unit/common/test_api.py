...
class TestEAPIClientExecute(testtools.TestCase):
    ...
    def _test_execute_error_helper(self, exception_to_throw):
        commands = ['config']

        self.client.session.post.side_effect = exception_to_throw

        retval = self.client.execute(commands)
        self._test_execute_helper(commands)
    ...
    def test_request_connection_error(self):
        self._test_execute_error_helper(requests_exc.ConnectionError)

    def test_request_connect_timeout(self):
        self._test_execute_error_helper(requests_exc.ConnectTimeout)

    def test_request_timeout(self):
        self._test_execute_error_helper(requests_exc.Timeout)

    def test_request_connect_InvalidURL(self):
        self._test_execute_error_helper(requests_exc.InvalidURL)
    ...
    def test_request_other_exception(self):
        ...
        commands = ['config']
        self.client.session.post.side_effect = OtherException
