...
class AristaDriver(driver_api.MechanismDriver):
    ...
    def _handle_port_migration_precommit(self, context):
        ...
        # commit are invoked with port with following settings:
        # +---------------------------------------------------------------+
        ...
        # |                    |             |                     [...]} |
        # +---------------------------------------------------------------+
        # Because of change in host_id, binding_levels in port context
        # and database will be cleared in _process_port_binding, and when
